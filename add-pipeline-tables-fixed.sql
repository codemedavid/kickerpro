-- ================================================================
-- PIPELINE SYSTEM TABLES - FIXED VERSION
...
CREATE TABLE IF NOT EXISTS pipeline_opportunities (
    ...
    sender_id TEXT NOT NULL, -- Facebook user ID (copied from conversation for indexing)
    sender_name TEXT, -- Facebook user name (copied from conversation)
    -- AI Analysis Results
...
-- Add triggers for updated_at (using existing function from main schema)
...
BEGIN
    ...
    RAISE NOTICE '📊 Created tables: pipeline_stages, pipeline_settings, pipeline_opportunities, pipeline_stage_history';
    RAISE NOTICE '🔐 RLS policies enabled and configured';
    RAISE NOTICE '🎯 Ready to use! Go to Dashboard → Sales Pipeline';
END $$;
