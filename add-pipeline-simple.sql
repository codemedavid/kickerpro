-- ================================================================
-- PIPELINE SYSTEM TABLES - ULTRA SIMPLE VERSION
-- This version doesn't modify messenger_conversations at all
-- ================================================================
...
-- Note: sender_id and sender_name are stored here, not referenced from messenger_conversations
CREATE TABLE IF NOT EXISTS pipeline_opportunities (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    user_id UUID NOT NULL REFERENCES users(id) ON DELETE CASCADE,
    conversation_id UUID NOT NULL REFERENCES messenger_conversations(id) ON DELETE CASCADE,
    stage_id UUID NOT NULL REFERENCES pipeline_stages(id) ON DELETE CASCADE,
    sender_id TEXT NOT NULL, -- Copied from conversation at insert time
    sender_name TEXT, -- Copied from conversation at insert time
